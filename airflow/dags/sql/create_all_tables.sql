...
CREATE TABLE IF NOT EXISTS DescriptionOffre (
    offre_id VARCHAR(7) NOT NULL PRIMARY KEY
    , intitule_offre VARCHAR(200)
    , description_offre VARCHAR(6000)
...
CREATE TABLE IF NOT EXISTS Offre_Experience (
    offre_id VARCHAR(7) NOT NULL
...
CREATE TABLE IF NOT EXISTS Offre_QualiteProfessionnelle (
    offre_id VARCHAR(7) NOT NULL
...
CREATE TABLE IF NOT EXISTS Offre_Qualification (
    offre_id VARCHAR(7) NOT NULL
...
CREATE TABLE IF NOT EXISTS Offre_PermisConduire (
    offre_id VARCHAR(7) NOT NULL
